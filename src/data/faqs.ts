...
export const faqs: FaqItem[] = [
  ...
  { category: "Pickup and delivery", question: "Do you offer pickup or delivery?", answer: "Delivery requests are currently considered across Pune, Pimpri-Chinchwad, Katraj, Hadapsar, Loni Kalbhor, Kunjirwadi and Uruli Kanchan. The final option and route availability are confirmed personally for each batch.", link: { href: "/delivery-areas", label: "See delivery-area details" } },
